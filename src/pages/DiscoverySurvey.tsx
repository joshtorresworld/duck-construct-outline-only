...
const universalQuestions = [
  ...
  },
  {
    ...
    category: "Technology",
    question: "How should our AI agents interact with your existing software?",
    type: "select" as const,
    options: [
      "Read-only — pull data from my systems, don't write back",
      "Bidirectional — read AND write/update my existing systems in real-time",
      "Bidirectional + sync — full two-way sync with conflict resolution",
      "Replace — I want to migrate off my current tools entirely",
      "Not sure — help me decide during onboarding",
    ],
  },
  {
    id: "api_readiness",
    category: "Technology",
    question: "Does your current software have API access or allow third-party integrations?",
    type: "select" as const,
    options: [
      "Yes — we already use API integrations",
      "Yes — available but not currently used",
      "Limited — some tools have APIs, others don't",
      "No — our tools are closed/legacy systems",
      "Not sure",
    ],
  },
  {
    id: "data_sync_frequency",
    category: "Technology",
    question: "How often should data sync between our agents and your existing systems?",
    type: "select" as const,
    options: [
      "Real-time (instant bidirectional sync)",
      "Near real-time (every 1–5 minutes)",
      "Periodic (hourly or daily batches)",
      "On-demand (manual trigger)",
      "Not sure — recommend based on my industry",
    ],
  },
  {
    id: "biggest_pain",
