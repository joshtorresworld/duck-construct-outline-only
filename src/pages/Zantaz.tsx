...
const Zantaz = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Integration with Row of Ducks Services */}
      <section className="py-16">
        <div className="container">
          <div className="mb-10">
            <p className="text-xs font-medium uppercase tracking-widest text-muted-foreground mb-2">
            ...
            <h2 className="text-2xl font-semibold text-foreground mb-2">
              How Zantaz Powers Our Three Service Pillars
            </h2>
            <p className="text-sm text-muted-foreground max-w-lg">
              Zantaz's Smart Stack maps directly to our core enterprise solutions — accelerating
              outcomes across Data Management, Information Security, and Business Continuity.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-4">
            {/* Data Management */}
            <motion.div {...anim(0)} className="duck-card bg-card rounded-lg overflow-hidden">
              <div className="px-5 pt-5 pb-3 flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <span className="tabular-nums text-xs font-mono text-muted-foreground">01</span>
                  <div className="w-2 h-2 rounded-full bg-success" />
                </div>
                <Database className="w-4 h-4 text-muted-foreground" strokeWidth={1.5} />
              </div>
              <div className="px-5 pb-3">
                <h3 className="text-lg font-semibold text-foreground mb-0.5">Data Management</h3>
                <p className="text-xs text-muted-foreground mb-3">Organize & Optimize</p>
                <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                  AI Smart Data Refinery cures Dark Data across SharePoint and file systems, while
                  AI Data Feeder mirrors only enriched, ROT-scrubbed data into OneLake and Fabric.
                </p>
              </div>
              <div className="px-5 pb-4">
                ...
                <ul className="space-y-1.5">
                  {["AI Smart Data Refinery", "AI Data Feeder + Smart Mirroring", "ROT elimination before analytics"].map((f) => (
              ...
              <div className="bg-surface-sunken px-5 py-3 border-t border-foreground/5">
                <div className="flex flex-wrap gap-1.5">
                  {["60% storage savings", "AI-Ready data", "Unified catalog"].map((o) => (
                    <span key={o} className="inline-flex items-center rounded-sm bg-background px-2 py-0.5 text-xs font-mono text-muted-foreground">
                      {o}
                    </span>
                  ))}
                </div>
            ...
            <motion.div {...anim(0.1)} className="duck-card bg-card rounded-lg overflow-hidden">
              <div className="px-5 pt-5 pb-3 flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <span className="tabular-nums text-xs font-mono text-muted-foreground">02</span>
              ...
              <div className="px-5 pb-3">
                <h3 className="text-lg font-semibold text-foreground mb-0.5">Information Security</h3>
                <p className="text-xs text-muted-foreground mb-3">Protect & Comply</p>
                <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                  AI-Ready Archiving provides compliance-grade journal archiving for Exchange and M365,
                  while AI Smart Legal accelerates regulatory response across thousands of matters.
                </p>
              </div>
              <div className="px-5 pb-4">
                <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-2">
                ...
                <ul className="space-y-1.5">
                  {["AI-Ready Archiving for M365", "AI Smart Legal for litigation", "SEC 17a-4, FINRA, GDPR compliance"].map((f) => (
                    <li key={f} className="flex items-center gap-2 text-sm text-foreground">
                      <CheckCircle2 className="w-3.5 h-3.5 text-success shrink-0" strokeWidth={1.5} />
                      {f}
                    </li>
              ...
              <div className="bg-surface-sunken px-5 py-3 border-t border-foreground/5">
                <div className="flex flex-wrap gap-1.5">
                  {["Regulatory confidence", "Zero-trust data", "Audit-ready"].map((o) => (
                    <span key={o} className="inline-flex items-center rounded-sm bg-background px-2 py-0.5 text-xs font-mono text-muted-foreground">
                      {o}
                    </span>
                  ))}
            ...
            {/* Business Continuity */}
            <motion.div {...anim(0.2)} className="duck-card bg-card rounded-lg overflow-hidden">
              <div className="px-5 pt-5 pb-3 flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <span className="tabular-nums text-xs font-mono text-muted-foreground">03</span>
                  <div className="w-2 h-2 rounded-full bg-muted-foreground/30" />
                </div>
                <RefreshCw className="w-4 h-4 text-muted-foreground" strokeWidth={1.5} />
              </div>
              <div className="px-5 pb-3">
                <h3 className="text-lg font-semibold text-foreground mb-0.5">Business Continuity</h3>
                <p className="text-xs text-muted-foreground mb-3">Recover & Sustain</p>
                <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                  Zantaz's archiving and data governance layer ensures enterprise data remains safe,
                  scalable, searchable, and recoverable — enabling confident AI adoption at scale.
                </p>
              </div>
              <div className="px-5 pb-4">
                <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-2">
                ...
                <ul className="space-y-1.5">
                  {["Retention-policy governance", "Geo-redundant archiving", "Copilot production readiness"].map((f) => (
                    <li key={f} className="flex items-center gap-2 text-sm text-foreground">
                      <CheckCircle2 className="w-3.5 h-3.5 text-success shrink-0" strokeWidth={1.5} />
                      {f}
                    </li>
              ...
              <div className="bg-surface-sunken px-5 py-3 border-t border-foreground/5">
                <div className="flex flex-wrap gap-1.5">
                  {["99.99% uptime", "Scalable archives", "AI-ready recovery"].map((o) => (
                    <span key={o} className="inline-flex items-center rounded-sm bg-background px-2 py-0.5 text-xs font-mono text-muted-foreground">
                      {o}
                    </span>
                  ))}
